...
- 2019.02.20 : [ボルボ、「90シリーズ」に先進安全機能を追加するアップグレードソフト発売。9288円から - Car Watch](https://car.watch.impress.co.jp/docs/news/1170634.html)
    > 「S90」「V90」「V90 クロスカントリー」「XC90」の2016年～2018年式モデルを対象に、4種類の先進安全・運転支援技術を追加するアップデートソフトウェアを発売した。City Safety 対向車対応機能以外の3種類は2017年式のS90、V90、V90 クロスカントリーと2016年～2017年式のXC90に対応し、価格は3つセットで9288円。（※販売店での有線ツールによるソフトウェアアップデート）
...
| ダウンロード中の制約        | 特になし                                            |
| インストール中の制約        | - 車両ロックされ、利用不可 <br> - インストール開始後数分以内に車両ロックしないとキャンセルされる[^S3]                                            |
| 更新履歴 | - 更新内容はセンターディスプレイの`information symbol`から確認可能 [^S3] |
|その他 | - 可能な限り、インストール中の充電ケーブルやその他機能の操作は控えること <br> - インストール中に車両に入りたい場合は、`key blade`(物理キー)を利用すること <br> - インストール中は、盗難防止アラームが解除される [^S3]|
| サポート | 販売店へ問い合わせ |
...
- [Volvo OTA Software-update UI (作成中)]()
